...
def disable_sketch(p, new_vals, has_sep):
    ...
    Args:
        ...
        has_sep: whethre the input table contains any value that can be applied to a separator (we may not need
            this arg, since we have not supported separate as operator
    ...
    def contains_repetition(_ast, except_list):
        ...
        for child in _ast["children"]:
            ...
            if child["type"] == "node":
                ...
                if (child["op"] == _ast["op"] and child["op"] not in except_list) or contains_repetition(child,
                                                                                                         except_list):
                    return True
