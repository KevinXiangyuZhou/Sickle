...
test_config = {
                "operators": ["group_sum", "mutate_2", "group_mutate"],
                "filer_op": ["=="],
                "constants": [3000],
...
annotated_output_009 = AnnotatedTable([
    {"value": "E.Els", "argument": [ArgOr([(0, 0, 0), (0, 0, 1)])], "operator": [], "attribute": "player"},
    {"value": "E.Els", "argument": [ArgOr([(0, 0, 0), (0, 0, 1)])], "operator": [], "attribute": "player"},
    {"value": 1, "argument": [(0, 1, 1)], "operator": [], "attribute": "rd"},
    {"value": 2, "argument": [(0, 1, 1)], "operator": [], "attribute": "rd"},
...
annotated_output_010 = AnnotatedTable([
    {"value": "Alabama", "argument": [(0, 0, 0)], "operator": [], "attribute": "state"},
    {"value": "Alaska", "argument": [(0, 0, 1)], "operator": [], "attribute": "state"},
    {"value": 1667, "argument": [(0, 1, 0)], "operator": [], "attribute": "count"},
    {"value": 507, "argument": [(0, 1, 1)], "operator": [], "attribute": "count"},
    {"value": None, "argument": [(0, 1, 0)], "operator": ["lambda x, y: (x / y) * 100 "], "attribute": "percentage"},
    {"value": None, "argument": [(0, 1, 1)], "operator": ["lambda x, y: (x / y) * 100 "], "attribute": "percentage"}
    ])
...
class SynthesizerTest(unittest.TestCase):
    #@unittest.skip
    def test_run(self):
        with open('../benchmark/tests/010.json', 'r') as filehandler:
            ...
            annotated_output = annotated_output_010
            candidates = Synthesizer(test_config_010).enumerative_synthesis(inputs, annotated_output, 3)
            for p in candidates:
    ...
    def test_13(self):
        ...
        annotated_output = AnnotatedTable(
            [{"value": 1.50, "argument": None, "operator": ["group_mean"], "attribute": "B"},
             {"value": 1, "argument": None, "operator": [], "attribute": "A"}]
        )
        candidates = Synthesizer(test_config_11).enumerative_synthesis(inputs, annotated_output, 3)
        print()
        for p in candidates:
